        ...
        <div className="hero-wrapper">
          <div className="hero-content">
            ...
            <div className="hero-buttons">
              ...
              <Link href="/how-it-works" className="btn-watch">How it works</Link>
            </div>
          </div>
        ...
        <div className="photo-grid">
          <div className="photo-item">
            <Image
              ...
              quality={100}
            />
            <div className="photo-location">Portland, OR</div>
          </div>
          <div className="photo-item">
            <Image
              src="/gallery-2.jpg"
              alt="Lake Berryessa, CA"
              fill
              style={{ objectFit: 'cover' }}
              quality={100}
            />
            <div className="photo-location">Lake Berryessa, CA</div>
          </div>
          <div className="photo-item">
            <Image
              src="/gallery-3.jpg"
              alt="Downtown OR Airport"
              fill
              style={{ objectFit: 'cover' }}
              quality={100}
            />
            <div className="photo-location">Downtown OR Airport</div>
          </div>
          <div className="photo-item">
            <Image
              src="/gallery-4.jpg"
              alt="The Ridge Raceway"
              fill
              style={{ objectFit: 'cover' }}
              quality={100}
            />
            <div className="photo-location">The Ridge Raceway</div>
          </div>
        </div>
      </section>
